...
contains
  ...
  subroutine compute_diff_wallflux (divw, dxinv, i,j,k, &
    ...
    real(rt) :: velocity, uvel, vvel, wvel, ublade, vblade, wblade, velmag, rad, theta, omega
    ...
    rad = dsqrt(x**2+y**2)
    omega = 2.0*3.14159265359*17.0077590009
    velmag = 2.00d0*3.14159265359d0/180.0d0*omega*cos(omega*time)*rad
    !velmag = 0.0d0
    theta = atan2(y,x)
