                ...
                const int max_coarsening_level, Real time, const int nstep )
{
    ...
    else if (geom_type == "moving_sphere")
    {
		...
		auto polys10 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6],planes[7]);
		clear_variables(point, normal, planes);
		...
		auto polys11 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6],planes[7]);
		clear_variables(point, normal, planes);
		...
		auto polys12 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6],planes[7]);
		clear_variables(point, normal, planes);
	...
	//auto tmp4 = EB2::makeDifference(polys9, polys10);
        ...
        auto polys13 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6],planes[7],
                                            planes[8],planes[9],planes[10],
                                            planes[11],planes[12],planes[13],
                                            planes[14],planes[15],planes[16],
                                            planes[17],planes[18],planes[19]);
        clear_variables(point, normal, planes);
        ...
        auto polys14 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6]);
        clear_variables(point, normal, planes);
        ...
        auto polys15 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3],
                                            planes[4],planes[5],planes[6],planes[7],planes[8]);
        clear_variables(point, normal, planes);
        ...
        auto polys16 = EB2::makeIntersection(planes[0],planes[1],planes[2]);
        clear_variables(point, normal, planes);

        //auto tmp4 = EB2::makeDifference(polys9, polys10);

        auto diff3 = EB2::makeDifference(polys13, polys14);
        auto E_final = EB2::makeDifference(diff3, polys15);
        ...
        auto polys17 = EB2::makeIntersection(planes[0],planes[1],planes[2],planes[3]);
        clear_variables(point, normal, planes);
		...
		auto X_final = EB2::translate(X_final_1,{0.0,val,val});
     	...
     	//auto gshop = EB2::makeShop(R_final);
