...
contains
  ...
  subroutine compute_hyp_wallflux (divw, i,j,k, rho, u, v, w, p, &
    ...
    real(rt) :: velocity, uvel, vvel, wvel, ublade, vblade, wblade,uwalldotn, twouwalldotn
    ...
    velocity = -1.0d0*1e-6*2.0d0*3.1415d0*1000.0d0*sin(2.0d0*3.1415d0*1000.0d0*time)
    ublade = velocity*(-anrmx)
    vblade = velocity*(-anrmy)
    wblade = velocity*(-anrmz)
