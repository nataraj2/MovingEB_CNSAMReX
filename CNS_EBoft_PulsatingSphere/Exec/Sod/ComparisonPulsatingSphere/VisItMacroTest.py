...
OpenDatabase("localhost:/Users/mnataraj/Desktop/Research/PeleC/Submodules/AMReX/Tutorials/EB/CNS_EBoft_PulsatingSphere/Exec/Sod/movie.visit", 0)
AddPlot("Pseudocolor", "pressure", 1, 0)

for i in range(0,57,1):
	DrawPlots()
	Query("Lineout", end_point=(0.5, 0, 0), num_samples=200, start_point=(0.01, 0, 0), use_sampling=0)
	SetActiveWindow(2)
	SetActiveWindow(2)
	SaveWindowAtts = SaveWindowAttributes()
	SaveWindowAtts.outputToCurrentDirectory = 0
	SaveWindowAtts.outputDirectory = "/Users/mnataraj/Desktop/Research/PeleC/Submodules/AMReX/Tutorials/EB/CNS_EBoft_PulsatingSphere/Exec/Sod/PulsatingSphereExact"
	filename="temp%04d"%i
