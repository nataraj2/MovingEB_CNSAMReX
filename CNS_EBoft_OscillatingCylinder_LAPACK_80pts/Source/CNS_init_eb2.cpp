                ...
                const int max_coarsening_level,Real time)
{
...

    {
        ...
        EB2::CylinderIF cf1(0.2, 10.0, 0, {0.0,0.2*0.4*cos(2.0*3.14159265359*24.375*0.8*time),7.0}, false);
        auto polys = EB2::makeUnion(cf1);
        auto gshop = EB2::makeShop(polys);
        EB2::Build(gshop, geom, max_coarsening_level, max_coarsening_level, 5,false);
    }
    
    else if(geom_type == "plane_centroid_check")
    {
