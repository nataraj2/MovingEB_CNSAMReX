...
subroutine amrex_probinit (init,name,namlen,problo,probhi) bind(c)
  ...
  inflow_state(umz) = 1.226d0*0.0d0
  inflow_state(ueden) = 101325.0d0/0.4d0 + 0.5*1.226*0.0d0**2!+ 0.5d0*1.226d0*5.0d0**2
  ...
  interior_state(umz) = 1.226d0*0.0d0
  interior_state(ueden) = 101325.0d0/0.4d0 + 0.5*1.226*0.0d0**2
