                ...
                const int max_coarsening_level,Real time)
{
	...
	//EB2::BoxIF box({0.005+shift, -0.01, -1.}, {0.025+shift, 0.01, 1.}, false);
        auto polys = EB2::makeIntersection(pf1,pf2,pf3);
        //auto polys = EB2::makeIntersection(pf2);
        //auto polys = EB2::makeIntersection(box);
        auto gshop = EB2::makeShop(polys);
    ...
    {
       	EB2::CylinderIF cf(0.02, 10.0, 0, {-0.03+459.54*time,0.0,0.0}, false);
